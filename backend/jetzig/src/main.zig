...
const hello_json =
    \\{"message":"Hello from Jetzig (Zig)!","framework":"Jetzig","language":"Zig"}
;
const health_json =
    \\{"status":"ok","service":"umf-jetzig","version":"1.0.0"}
;
const root_json =
    \\{"message":"UMF-DevKit Jetzig service is running.","framework":"Jetzig","language":"Zig"}
;
...
pub fn main() !void {
    ...
    std.debug.print("Jetzig listening on port {d}\n", .{PORT});
